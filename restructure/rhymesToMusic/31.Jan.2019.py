...
inputText = "This is my sample string"#input("Please enter a string of text to convert: \n\n")

scaleType = "major"#input("\nChoose a type of scale: \n    major\n    minor \n\n")

outputName = nameBeginning+'{:%Y%m%d%H%M}'.format(datetime.datetime.now())#input("\nType an output file name. For example 'filename' will become filename.mid\n\n")
